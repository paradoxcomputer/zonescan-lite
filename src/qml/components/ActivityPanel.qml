    ...
    Column {
        ...
        Rectangle {
            ...
            Row {
                ...
                spacing: 10
                Text { text: "Channel activity"; color: ZT.pal.navy; font.pixelSize: 14; font.weight: Font.DemiBold; anchors.verticalCenter: parent.verticalCenter }
                Rectangle {
                    anchors.verticalCenter: parent.verticalCenter
                    property var fc: ZT.finBadge[root.desc.tier]
        ...
        Text {
            ...
            text: root.desc.headline; color: ZT.pal.navy; font.pixelSize: 13; font.weight: Font.DemiBold; wrapMode: Text.WordWrap
        }
        // kv grid
        Grid {
            ...
            Text { width: parent.kw; text: "Activity (L1 slots)"; color: ZT.pal.soft; font.pixelSize: 12 }
            Text { width: parent.width - parent.kw - 18; text: ZT.num(root.start) + " → " + ZT.num(root.tip); color: ZT.pal.fg; font.pixelSize: 13; font.family: "ui-monospace, Menlo, Consolas, monospace"; wrapMode: Text.WrapAnywhere }
            // finality eta (finalizing only)
            Text { visible: root.desc.eta.length > 0; width: parent.kw; text: "Finality"; color: ZT.pal.soft; font.pixelSize: 12 }
            Text { visible: root.desc.eta.length > 0; width: parent.width - parent.kw - 18; text: root.desc.eta + "  (tip slot " + ZT.num(root.tip) + " vs last-final " + ZT.num(root.lib) + ")"; color: ZT.pal.fg; font.pixelSize: 13; wrapMode: Text.WordWrap }
            Text { width: parent.kw; text: "Inscriber"; color: ZT.pal.soft; font.pixelSize: 12 }
            Text { width: parent.width - parent.kw - 18
                ...
                color: ZT.pal.fg; font.pixelSize: 12; font.family: "ui-monospace, Menlo, Consolas, monospace"; wrapMode: Text.WrapAnywhere }
            Text { width: parent.kw; text: "Tip hash"; color: ZT.pal.soft; font.pixelSize: 12 }
            Text { width: parent.width - parent.kw - 18; text: root.seq && root.seq.tip_message ? ZT.sh(root.seq.tip_message, 10, 6) : "-"; color: ZT.pal.fg; font.pixelSize: 12; font.family: "ui-monospace, Menlo, Consolas, monospace" }
            Text { width: parent.kw; text: "Channel balance"; color: ZT.pal.soft; font.pixelSize: 12 }
            Text { width: parent.width - parent.kw - 18; text: root.seq && root.seq.l1_balance != null ? ZT.num(root.seq.l1_balance) : "-"; color: ZT.pal.fg; font.pixelSize: 13; font.family: "ui-monospace, Menlo, Consolas, monospace" }
        }
        // note
        Text {
            x: 18; topPadding: 6; bottomPadding: 16; width: parent.width - 36
            text: root.desc.note; color: ZT.pal.muted; font.pixelSize: 12; lineHeight: 1.4; wrapMode: Text.WordWrap
        }
    }
}
